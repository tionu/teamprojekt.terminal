...
public class EgkData {
	...
	private int versichertenverhaeltnis;
	...
	public int getVersichertenverhaeltnis() {
		return versichertenverhaeltnis;
	}
	public void setVersichertenverhaeltnis(int versichertenverhaeltnis) {
		this.versichertenverhaeltnis = versichertenverhaeltnis;
	}
